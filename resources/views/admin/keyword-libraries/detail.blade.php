        ...
        <div class="bg-white shadow rounded-lg">
            ...
            @else
                <div id="batch-actions" class="hidden border-b border-gray-200 bg-gray-50 px-6 py-3" data-keyword-batch-panel>
                    <form method="POST" action="{{ route('admin.keyword-libraries.keywords.delete', ['libraryId' => (int) $library->id]) }}" id="batch-form" data-keyword-batch-form data-selected-template="{{ __('admin.keyword_detail.selected_count', ['count' => '{count}']) }}" data-confirm-template="{{ __('admin.keyword_detail.confirm_delete_selected', ['count' => '{count}']) }}">
                        @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
                        @foreach ($keywords as $keyword)
                            <div class="group flex items-center justify-between p-3 border border-gray-200 rounded-lg hover:bg-gray-50">
                                ...
                                <form method="POST" action="{{ route('admin.keyword-libraries.keywords.delete', ['libraryId' => (int) $library->id]) }}" data-material-delete-form data-confirm-message="{{ __('admin.keyword_detail.confirm_delete_keyword', ['name' => $keyword->keyword]) }}">
                                    @csrf
